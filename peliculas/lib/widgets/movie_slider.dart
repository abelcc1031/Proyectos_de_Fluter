    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Expanded( // Entonces toma todo el tamaño disponible
            child: ListView.builder( // El listview.builder no sabe que tamaño tomar por que se define basado en el padre y el tamaño del padre es flexible
